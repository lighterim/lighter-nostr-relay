        ...
        + JSON.stringify(
            {
                ...
                'content': "take intent",
                'tags': [
                    ['take','buy', $("#eventId").val(), $("#userId").val(), $("#pubkey").val(), $("#volume").val(), $("#userId2").val(), $("#pubkey2").val(), "0", "0", $("#userId").val()],
                    ...
                    ["limit", "11111", "222222"],
                    ["permit2", "sss", "sss", "ddd", "zz", "0xc73a3413406d719ea763d4d122eb371a1956292f", "0x000000000022D473030F116dDEE9F6B43aC78BA3", "Permit2"],
